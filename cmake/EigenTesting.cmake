...
macro(ei_add_test_internal testname testname_with_suffix)
  ...
  if(EIGEN_ADD_TEST_FILENAME_EXTENSION STREQUAL cu)
    if(NOT EIGEN_INTEGRATED_CUDA_COMPILER)
      if (${ARGC} GREATER 2)
      ...
      if(CUDA_64_BIT_DEVICE_CODE)
        message("XXX XXX Adding lib64 for test ${testname}: ${CUDA_TOOLKIT_ROOT_DIR}")
        link_directories("${CUDA_TOOLKIT_ROOT_DIR}/lib64")
      else()
        message("XXX XXX Adding lib for test ${testname}: ${CUDA_TOOLKIT_ROOT_DIR}")
...
macro(ei_testing_print_summary)
  ...
  message(STATUS "Maximal matrix/vector size: ${EIGEN_TEST_MAX_SIZE}")
   ...
   if(EIGEN_TEST_FMA)
    ...
    # Integrated CUDA compiler means we use the host compiler to compile CUDA
    # (works with clang).  Otherwise, we use nvcc.
    if (EIGEN_INTEGRATED_CUDA_COMPILER)
      message(STATUS "CUDA compiler:     Integrated")
    else()
